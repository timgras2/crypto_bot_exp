...
class TestConfig(unittest.TestCase):
    def setUp(self):
        ...
        os.environ["BITVAVO_RATE_LIMIT"] = "250"
        os.environ["BITVAVO_API_TIMEOUT"] = "25"
    ...
    def tearDown(self):
        ...
        keys = [
            ...
            "BITVAVO_BASE_URL", "BITVAVO_RATE_LIMIT", "BITVAVO_API_TIMEOUT", "OPERATOR_ID"
        ]
        for key in keys:
    ...
    def test_load_config(self):
        ...
        # Check ExchangeConfig structure
        self.assertEqual(exchange_config.enabled_exchanges, ["bitvavo"])
        self.assertEqual(exchange_config.primary_exchange, "bitvavo")
        self.assertIsNotNone(exchange_config.bitvavo)
        self.assertIsNone(exchange_config.kucoin)
        
        # Check Bitvavo APIConfig values  
        bitvavo_config = exchange_config.bitvavo
        self.assertEqual(bitvavo_config.api_key, "3cc98733593ffecc74e8a62dd5d3bd05f883ed81c5f6f95dd47c15f7bf70337d")
        self.assertEqual(bitvavo_config.api_secret, "9630f918a75642bb1ee763eecfe8813798db164d346727bc3b1b5d98f53bd6a85597e344ac670fad07068dfee7ebd0755d089632ea218265ca0c192b6caee1b9")
        self.assertEqual(bitvavo_config.base_url, "https://api.test.com/v2")
        self.assertEqual(bitvavo_config.rate_limit, 250)
        self.assertEqual(bitvavo_config.timeout, 25)
